...
const CardSlider = () => {
  const slides = [
    ...
    { id: 2, img: "Images/Slider2-Img.png", title: "Booking Boost", subtitle: "More appointments, fewer no-shows", maindes: "Up to 40%", desc: "Real-time calendar sync confirms appointments, sends reminders, and simplifies rescheduling to lift conversions and cut no-shows." },
    { id: 3, img: "Images/Slider3-Img.png", title: "Lead Recovery", subtitle: "Capture missed & after-hours callers", maindes: "Up to 3×", desc: "Answer after-hours, auto-callback missed numbers, qualify intent, and route hot prospects to staff or instant calendar booking." },
    { id: 4, img: "Images/Slider4-Img.png", title: "Peak-Hour Control", subtitle: "Handle call spikes without holds", maindes: "Up to 50%", desc: "Parallel answering absorbs call spikes, triages intent, books fast, and escalates urgent cases, reducing holds and abandons." },
    { id: 5, img: "Images/Slider5-Img.png", title: "Team Efficiency", subtitle: "Time back for your staff", maindes: "Up to 10+", desc: "Offload FAQs and scheduling so staff focus on customers, while notes sync to calendar, CRM, and POS automatically." },
